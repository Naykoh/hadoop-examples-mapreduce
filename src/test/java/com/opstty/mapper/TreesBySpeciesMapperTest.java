...
public class TreesBySpeciesMapperTest {
    @Mock
    private Mapper.Context context;
    private TreesBySpeciesMapper treesBySpeciesMapper;

    @Before
    public void setup() {
        this.treesBySpeciesMapper = new TreesBySpeciesMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.treesBySpeciesMapper.map(null, new Text(value), this.context);
