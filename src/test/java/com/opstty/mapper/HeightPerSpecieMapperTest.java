...
public class HeightPerSpecieMapperTest {
    @Mock
    private Mapper.Context context;
    private HeightPerSpecieMapper heightPerSpecieMapper;

    @Before
    public void setup() {
        this.heightPerSpecieMapper = new HeightPerSpecieMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        String value = "GEOPOINT;ARRONDISSEMENT;GENRE;ESPECE;FAMILLE;ANNEE PLANTATION;HAUTEUR;CIRCONFERENCE;ADRESSE;NOM COMMUN;VARIETE;OBJECTID;NOM_EV\n" +
                "(48.857140829, 2.29533455314);7;Maclura;pomifera;Moraceae;1935;;;Quai Branly, avenue de La Motte-Piquet, avenue de la Bourdonnais, avenue de Suffren;Oranger des Osages;;6;Parc du Champs de Mars\n" +
        ...
        this.heightPerSpecieMapper.map(null, new Text(value), this.context);
        verify(this.context, times(1))
                .write(new Text( "decurrens"), new IntWritable(20));
    }
}