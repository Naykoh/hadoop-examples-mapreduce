...
public class TreeSortedMapperTest {
    @Mock
    private Mapper.Context context;
    private TreeSortedMapper treeSortedMapper;

    @Before
    public void setup() {
        this.treeSortedMapper = new TreeSortedMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.treeSortedMapper.map(null, new Text(value), this.context);
        verify(this.context, times(1))
                .write(new IntWritable(13) ,new Text( "pomifera"));
    }
}